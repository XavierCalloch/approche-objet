...
public class StringUtils {
	...
	public static int levenshteinDistance(CharSequence lhs, CharSequence rhs) { // throws IncorrectParameterException
		// Rajouter @throws Incorrect... dans la javadoc ci-dessus
		// Correctif pour rendre la classe plus robuste
		if (lhs == null || rhs ==  null) {
			return -1; // ou retourner une exception
			// throw new IncorrectParameterException("Vous n'avez pas le droit...
		}
